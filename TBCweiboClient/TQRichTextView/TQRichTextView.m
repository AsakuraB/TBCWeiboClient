...
- (void)createDefault
{
    ...
    self.runTypeList = TQRichTextRunURLType | TQRichTextRunEmojiType | TQRichTextRunAtType | TQRichTextRunTopicType;
    self.lineSpace   = 2.0f;
...
+ (NSArray *)createTextRunsWithAttString:(NSMutableAttributedString *)attString runTypeList:(TQRichTextRunTypeList)typeList
{
    ...
    if (typeList != TQRichTextRunNoneType)
    {
        ...
        if ((typeList & TQRichTextRunAtType) == TQRichTextRunAtType)
        {
            [array addObjectsFromArray:[TQRichTextRunAt runsForAttributedString:attString]];
        }
        
        if ((typeList & TQRichTextRunTopicType) == TQRichTextRunTopicType)
        {
            [array addObjectsFromArray:[TQRichTextRunTopic runsForAttributedString:attString]];
        }
...
{
    [[self class] createTextRunsWithAttString:attString runTypeList:TQRichTextRunURLType | TQRichTextRunEmojiType | TQRichTextRunAtType | TQRichTextRunTopicType];
