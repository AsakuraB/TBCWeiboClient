...
+ (NSArray *) emojiStringArray
{
    ...
    NSDictionary *emojiDic = [[NSDictionary alloc] initWithContentsOfFile:filePath];
    NSArray *array = [emojiDic allKeys];
    return array;
}
...
- (void)drawRunWithRect:(CGRect)rect
{
    ...
    NSString *filePath = [[[NSBundle mainBundle] resourcePath] stringByAppendingPathComponent:@"emotionImage.plist"];
    NSDictionary *emojiDic = [[NSDictionary alloc] initWithContentsOfFile:filePath];
    NSString *emojiString = [emojiDic objectForKey:[NSString stringWithFormat:@"%@",self.text]];
