...
NSString *const MJRefreshFooterPullToRefresh = @"上拉可以加载更多微博";
NSString *const MJRefreshFooterReleaseToRefresh = @"松开立即加载更多微博";
...
NSString *const MJRefreshHeaderRefreshing = @"正在努力刷新中...";
